...
<body>
	...
	<script src="<?php echo base_url(JS."libs/jquery.wookmark.js");?>"></script>
	<script src="<?php echo base_url(JS."libs/jquery.filterme.js");?>"></script>
	...
	<script src="<?php echo base_url(JS."infinite_loop.js");?>"></script>
