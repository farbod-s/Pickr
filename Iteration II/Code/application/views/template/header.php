<header id="header" class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container-fluid">
			...
			<a class="brand" href="<?php echo base_url();?>"><img src="<?php echo  base_url(IMAGES.'pickr_logo.png');?>" alt="pickr"
		          ...
		          <li class="dropdown">
		            ...
		            <div class="dropdown-menu" style="padding: 15px;">
		              ...
		              <div id="formContainer">
						  ...
						  <input type="text" id="name" name="name" value="<?php echo set_value('name'); ?>" maxlength="20" placeholder="Username" spellcheck="false" required />
	                	  <input type="password" id="pass" name="pass" value="<?php echo set_value('pass'); ?>" placeholder="Password" required />
	              	 	  ...
	              	 	  <?php echo form_close(); ?>
						  <?php $attributes = array('id' => 'recovery-form');
	        	...
	        	<ul class="nav pull-left">
		          ...
		          <li class="dropdown">
		            <a class="dropdown-toggle" href="#" data-toggle="dropdown">
		            	...
		            	<strong>Unknown</strong> <strong class="caret"></strong>
		            </a>
		            	<!-- User Control -->
		            	<ul class="dropdown-menu">
			            	<li><a href="#"><i class="icon-picture"></i> Albums</a></li>
						    <li><a href='<?php echo base_url()."index.php/user/setting"; ?>'><i class="icon-pencil"></i> Setting</a></li>
